<div class="container-fluid">
  <h1 class="text-center" style="padding: 20px; font-weight:bold">All Promos</h1>
  ...
  <table id="table" class="table table-stripped table-bordered dataTable responsive display nowrap no-footer dtr-inline collapsed printTable darkBG" role="grid" cellspacing="0" style="width:100%">
    ...
    <tbody>
      ...
      <?php
      $category_query = "SELECT * FROM products  WHERE category_id ='2' ORDER BY date";
      ...
      while ($row = mysqli_fetch_assoc($result_category)) {
        ...
        echo "
            ...
            <td> "; ?>
        <a href="./shop/edit_products.php?id= <?php echo $product_code ?>" class='text-warning'><i class='bi bi-pencil-square'></i></a>
      <?php
        echo "
           </td>
