...
<body style="font-family: 'Poppins', sans-serif; background-color: rgb(247, 247, 247);">
          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <a class="dropdown-item" href="#appform" onclick="hideSections()">Join Us - Franchise</a>
                  <a class="dropdown-item" href="#">Product Feedback</a>
                  <a class="dropdown-item" href="#">Complaints</a>
                  <a class="dropdown-item" href="#jobApp" onclick="hideJob()">Job Application</a>
                  </div>
                </li>
              </ul>
            </div>
    ...
    <section class="application" id="appform" style="display: none;">
      <div class="container-fluid">
        <div class="row">
    ...
    <section class="application" id="jobApp" style="display: none;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-8 mb-3">
            <form class="applyNow" action="jobApplication.php" method="POST">
              <div class="container-fluid mt-3" style="margin-left: 10px;">
