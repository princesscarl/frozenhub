        ...
        <div class=" col-lg-4" id="contactUs">
          <div class="contacts container-fluid p-3">
            ...
            <ul style="list-style-type:none;">
              <li><i class="bi bi-telephone" style="font-size: 1em;"></i><a> 0962 071 8415</a></li>
              <li><i class="bi bi-envelope" style="font-size: 1em;"></i><a class="conLink" href="frozenhubhr@gmail.com"> frozenhubhr@gmail.com</a></li>
              <li><i class="bi bi-facebook" style="font-size: 1em;"></i><a class="conLink" href="https://www.facebook.com/FrozenHubco"> FrozenHub</a></li>
              <li><i class="bi bi-instagram" style="font-size: 1em;"></i><a class="conLink" href="https://www.instagram.com/frozenhub_official/"> frozenhub_official</a></li>
            </ul>
          </div>
