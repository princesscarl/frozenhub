...
<?php
      ...
      $user_id = $_SESSION['user_id'];
                    ...
                    if ($count == 0){
                      echo'<h1 class="text-center">No orders for delivery. Shop now!</h1>';
...
<a href="./view_orders.php" class="btn btn-secondary ml-5 p-2 py-2 border-0 text-decoration-none text-light ml-5 mb-3">Pending</a>
