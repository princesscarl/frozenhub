...
<?php
      ...
      $user_id = $_SESSION['user_id'];
                    ...
                    if ($count == 0){
                      echo'<h1 class="text-center">No cancelled orders. Shop now!</h1>';
...
echo'
<h1 class="text-center" id="reqsHeading" style="margin-bottom: 12px;padding-bottom: 8px;padding-top: 12px;">Cancelled Orders</h1>
