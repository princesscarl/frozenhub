<div class="container-fluid">
  <h1 class="text-center" style="padding: 20px; font-weight:bold">All Products</h1>

  <!-- <button type="button" onclick="window.history.back()" class="btn btn-warning p-2 py-2 border-0 text-decoration-none text-light mb-3">Back</button> -->
